@extends('layouts.app')
@section('title', 'Daftar Nilai Anak')

@section('content')
<div class="container grid px-6 mx-auto">
    <h2 class="my-6 text-2xl font-semibold text-gray-700 dark:text-gray-200">
        Daftar Nilai Anak: {{ $siswa->nama }}
    </h2>

    <div class="p-4 mb-6 bg-white rounded-lg shadow-md dark:bg-gray-800">
        <form action="{{ route('orangtua.nilai.index') }}" method="GET" class="flex flex-col space-y-4 md:flex-row md:items-end md:space-y-0 md:space-x-4">
            <div class="flex-1">
