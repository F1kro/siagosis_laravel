                ...
                <div class="flex flex-col items-center space-y-6 lg:col-span-1 lg:items-start">
                    <div class="overflow-hidden rounded-lg shadow-lg ">
                        ...
                        @if ($profilePhotoToShow)
                            <img src="{{ asset('storage/' . $profilePhotoToShow) }}" alt="{{ $user->name }} Profile Photo"
                    ...
                    <div
                        class="w-full p-4 text-sm text-gray-700 bg-gray-100 rounded-lg dark:bg-gray-700 dark:text-gray-300">
                    ...
                    @if ($user->isGuru() || $user->isSiswa())
                        <form action="{{ route('user.profile.update-photo') }}" method="POST"
                            enctype="multipart/form-data" class="w-full max-w-xs space-y-4">
                            @csrf
                            <div>
                                <label for="foto"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Ganti Foto
                                    Profil</label>
                                <input type="file" name="foto" id="foto"
                                    class="block w-full p-2 mt-1 text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-l-md file:border-0 file:text-sm file:font-semibold file:bg-purple-50 file:text-purple-700 hover:file:bg-purple-100 dark:file:bg-purple-700 dark:file:text-purple-50 dark:hover:file:bg-purple-600">
                                @error('foto')
                ...
                <div class="space-y-8 lg:col-span-2 ">
                    ...
                    <div class="p-4 rounded-lg shadow-md sm:p-6 bg-gray-50 dark:bg-gray-700">
                        ...
                        <form action="{{ route('user.profile.update') }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                <label for="email"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Email Akun</label>
                        ...
                        <form action="{{ route('user.profile.update-password') }}" method="POST" class="space-y-6">
                            ...
                            <div>
                                <label for="current_password"
                                    class="block text-sm font-medium text-gray-700 dark:text-gray-300">Password Saat
                                    Ini</label>
                                <input type="password" name="current_password" id="current_password"
                                    class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input @error('current_password') border-red-500 @enderror"
