...
x-data="{
    ...
    updateCurrentRoute() {
        ...
        this.isPagesMenuOpen = this.checkActive('/admin/siswa') ||
                               ...
                               this.checkActive('/admin/user') ||
                               this.checkActive('/admin/kelas') ||
                               this.checkActive('/admin/mapel');
    }
}"
x-init="updateCurrentRoute()"
@update-route.window="updateCurrentRoute()">
<div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <ul class="mt-6">
        <li class="relative px-6 py-3">
            <span
                class="absolute inset-y-0 left-0 w-3 bg-red-600 rounded-tr-lg rounded-br-lg"
                aria-hidden="true"
                x-show="currentRoute === '/admin/dashboard'"
            ></span>
            ...
            <li class="relative px-6 py-3" :class="{'bg-indigo-50 dark:bg-indigo-900': isPagesMenuOpen}">
                <button
                    ...
                    <span class="inline-flex items-center">
                        <i class="w-5 h-5 fas fa-database" :class="{'text-indigo-600 dark:text-indigo-400': isPagesMenuOpen}"></i>
                        <span class="ml-4" :class="{'text-indigo-600 dark:text-indigo-400': isPagesMenuOpen}">Master Data</span>
                    </span>
                    <i class="w-4 h-4 pl-0 pr-1 mr-1 fas fa-chevron-down" :class="{'transform rotate-180': isPagesMenuOpen}"></i>
                </button>
                <template x-if="isPagesMenuOpen">
                    <ul x-transition:enter="transition-all ease-in-out duration-300"
                        ...
                        aria-label="submenu">
                        <li
                            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-100"
                            :class="{'bg-red-100 dark:bg-red-600 text-red-600 dark:text-gray-300 dark:rounded-md rounded-md': checkActive('/admin/siswa')}">
                            <a class="w-full" href="{{ route('admin.siswa.index') }}"><i class="mr-2 fas fa-user-graduate"></i>Data Siswa</a>
                        </li>
                        <li
                        ...
                        <li
                            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                            :class="{'bg-indigo-100 dark:bg-indigo-800 text-indigo-600 dark:text-indigo-300': checkActive('/admin/user')}">
                            <a class="w-full" href="{{ route('admin.siswa.index') }}"><i class="mr-2 fas fa-user-shield"></i>Data User</a>
                        </li>
                        <li
                            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                            :class="{'bg-indigo-100 dark:bg-indigo-800 text-indigo-600 dark:text-indigo-300': checkActive('/admin/kelas')}">
                            <a class="w-full" href="{{ route('admin.kelas.index') }}"><i class="mr-2 fas fa-door-open"></i>Data Kelas</a>
                        </li>
                        <li
                            class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                            :class="{'bg-indigo-100 dark:bg-indigo-800 text-indigo-600 dark:text-indigo-300': checkActive('/admin/mapel')}">
                            <a class="w-full" href="{{ route('admin.mapel.index') }}"><i class="mr-2 fas fa-book"></i>Data Mapel</a>
                        </li>
                    </ul>
                </template>
            </li>
...
<!-- Mobile Sidebar -->
<aside
  class="fixed inset-y-0 left-0 z-20 w-64 mt-16 overflow-y-auto bg-white dark:bg-gray-800 md:hidden"
  x-show="isSideMenuOpen"
  x-transition:enter="transition ease-in-out duration-150"
  ...
  <div class="py-4 text-gray-500 dark:text-gray-400">
    ...
    <ul>
      ...
      <li class="relative px-6 py-3">
        ...
        <ul x-ref="masterDataMenu" class="hidden p-2 mt-2 space-y-2 text-sm font-medium text-gray-500 rounded-md shadow-inner bg-gray-50 dark:text-gray-400 dark:bg-gray-900">
