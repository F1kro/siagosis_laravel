<ul>
    ...
    <li class="relative px-6 py-3"><span
            ...
            href="{{ route('orangtua.nilai.index') }}"><i class="w-5 h-5 fas fa-star"></i><span class="ml-4">Nilai
                Anak</span></a></li>
    <li class="relative px-6 py-3"><span
            class="absolute inset-y-0 left-0 w-1 rounded-tr-lg rounded-br-lg {{ request()->is('orangtua/ranking*') ? 'bg-purple-600' : '' }}"></span><a
            class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200 {{ request()->is('orangtua/ranking*') ? 'text-gray-800 dark:text-gray-100' : '' }}"
            href="{{ route('orangtua.ranking.index') }}"><i class="w-5 h-5 fas fa-ranking-star"></i><span class="ml-4">Ranking
                Anak</span></a></li>
    <li class="relative px-6 py-3"><span
            ...
            href="{{ route('orangtua.berita.index') }}"><i class="w-5 h-5 fas fa-newspaper"></i><span
                class="ml-4">Berita & Info</span></a></li>
</ul>
