        ...
        <form action="{{ route('admin.ranking.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-4">
                <div>
                    ...
                    <select name="tahun_ajaran" id="tahun_ajaran" required class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                ...
                <div>
                    ...
                    <select name="semester" id="semester" required class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
                ...
                <div>
                    ...
                    <select name="kelas_id" id="kelas_id" required class="block w-full mt-1 text-sm dark:text-gray-300 dark:border-gray-600 dark:bg-gray-700 form-select focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:focus:shadow-outline-gray">
            ...
            <table class="w-full whitespace-no-wrap">
                ...
                <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                    ...
                    <tr class="text-gray-700 dark:text-gray-400">
                        ...
                        <td class="px-4 py-3 text-sm">{{ \Carbon\Carbon::parse($riwayat->tanggal_dibuat)->format('d M Y H:i') }}</td>
                        <td class="px-4 py-3 text-sm">
                            <form id="delete-form-{{ $loop->index }}" action="{{ route('admin.ranking.destroy') }}" method="POST">
                                @csrf
                                @method('DELETE')
                                ...
                                <button type="button" onclick="confirmDelete({{ $loop->index }})" class="px-2 py-1 text-xs font-medium text-white bg-red-600 rounded-md hover:bg-red-700 focus:outline-none">
                                    Hapus
                                </button>
                            </form>
                        </td>
                    ...
                    @empty
                    <tr class="py-3">
                        <td colspan="6" class="px-4 py-10 text-center dark:text-gray-300">Belum ada riwayat peringkat yang digenerate.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
